...
export default function AuthModal({ isOpen, onClose, initialMode = 'login' }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Main Container */}
            <div className="relative  top-[40px] w-[100%] max-w-lg bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-[25px] pt-[40px] border border-white/20 max-h-[92vh] overflow-y-auto">
                {/* Close Button */}
                <button
                    onClick={onClose}
                ...
                <div className="space-y-3">
                    <button className="w-full py-3.5 px-4 bg-white border-2 border-gray-200 rounded-xl font-medium text-gray-700 hover:border-gray-300 hover:shadow-md transition-all flex items-center justify-center space-x-3">

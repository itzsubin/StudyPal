...
export default function SignUp({ formData, handleChange, handleSubmit, isLoading }) {
    ...
    return (
        <div className="space-y-5">
            ...
            <button
                ...
                disabled={isLoading}
                className={`w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 group ${isLoading ? 'opacity-70 cursor-not-allowed scale-100' : ''}`}
            >
                {isLoading ? (
                    <>

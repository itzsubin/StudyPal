        ...
        >
            ...
            <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
                ...
                <div style={{
                    ...
                    <Ballpit count={50} gravity={0.5} friction={0.9} wallBounce={0.9} followCursor={false} />
                </div>

                <div className="sm-panel-inner" style={{ position: 'relative', zIndex: 1 }}>
